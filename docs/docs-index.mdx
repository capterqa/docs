...
The example above is very small and doesn't do much. Have a look at the [get started guide](/cli/getting-started/installation) to learn how to add more steps, assertions and how to compose advanced requests.
