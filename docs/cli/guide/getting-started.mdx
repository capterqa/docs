...
sidebar_label: Gettings started
slug: /cli/guide/getting-started
---

After [installing the Capter CLI](/cli/installation) it's time to create your first _workflow_. You write your workflows in **YAML**, which should be a familiar language if you have used something like GitHub Actions or Travis CI before.
...
Just checking the health endpoint is probably not why you're looking in to Capter – there are a lot of other tools that can do that! The next step is to learn how to [compose requests](/cli/composing-requests), or if you want to see Capter in action you can head over to the [examples](/docs/cli/examples).
